					...
					<div>
						<?php
							if(isset($_GET['registerd'])){
								echo'
									<p>Thank fo registering with the Muthurua Market tax system. Please log in to the system to set up all your details<p/>
								';
							}
						?>
					</div>
					<div class="form-group">
						<label class="labels">Enter business name</label><br />
						<input type="text" class="input" name="email" placeholder="Enter email address" />
					</div>
					<div class="form-group">
						<label class="labels">Id number</label><br />
